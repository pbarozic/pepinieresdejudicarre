...
<h3 className="relative text-white lg:text-8xl text-6xl z-1 mx-6">Plus de 100 nouvelles variétés cette saison</h3>
</div>
...
<button className="bg-teal-950 hover:bg-teal-900 text-white font-bold py-2 px-4 rounded">
  Contactez-vous
</button>
