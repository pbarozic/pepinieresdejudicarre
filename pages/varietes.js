...
function Varietes() {
  ...
  function VarieteSquares({ text, imgSrc, path }) {
    ...
    return (
      ...
      >
        <div className="m-4">
          <div
            className="aspect-ratio-square w-full h-full relative z-0"
            style={{ paddingBottom: "100%" }}
          >
            <h3
              className={`absolute top-0 left-0 text-center w-full h-full text-5xl text-white p-4 flex items-center justify-center z-20 ${
                hovered ? "font-bold" : ""
              }`}
            >
              {text}
            ...
            />
            <div
              className={`absolute inset-0 bg-teal-950 ${
                hovered ? "opacity-10" : "opacity-20"
              } z-0`}
            ></div>
          </div>
        </div>
  ...
  return (
    <div className="mt-14 h-screen flex lg:flex-row flex-wrap justify-center">
      <div className="h-1/2 lg:h-4/6 flex justify-center lg:mb-8">
        <div className="h-1/2 lg:h-4/6 w-full absolute z-0">
          <div className="h-full w-full relative">
            <Image
              ...
              alt="Rameau d'olivier au coucher de soleil"
              layout="fill"
              objectFit="cover"
            />
        ...
        <div className="h-5/6 lg:h-full w-full lg:w-5/6 relative z-10 flex flex-col justify-around items-center">
          ...
          <a
            ...
            className="bg-slate-100 hover:bg-white text-teal-950 font-bold py-2 px-4 rounded cursor-pointer"
          >
            Découvrir
          </a>
        </div>
        ...
        <div className="h-1/3 w-full px-8 absolute z-0">
          <div className="h-full w-full relative">
            <Image
              ...
              alt="fleurs blanches sur fond vert"
              layout="fill"
              objectPosition="50% 7%"
              objectFit="cover"
            />
      ...
      <div className="h-min-screen px-4 lg:h-full w-full flex lg:flex-row justify-center items-center flex-wrap">
        <VarieteSquares
          key={32}
          text="Nouveautés"
        ...
        <div className="w-screen flex lg:flex-row flex-col lg:pb-8 pb-28">
          <VarieteSquares
            key={30}
          ...
          >
            <div className="m-4">
              <div
                className="aspect-ratio-square w-full h-full relative z-0 bg-teal-950 hover:bg-teal-900"
                style={{ paddingBottom: "100%" }}
              >
                <div className="h-full w-full absolute top-0 left-0 flex flex-col justify-center items-center">
                  ...
                  <FontAwesomeIcon
                    className="text-white cursor-pointer w-1/2 h-1/2 mt-3"
                    icon={faTruck}
                  />
                </div>
              </div>
