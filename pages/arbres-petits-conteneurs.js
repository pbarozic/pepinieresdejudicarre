...
function Variété() {
    return (
        ...
        <div className='h-1/2 lg:h-1/2 flex justify-center lg:mb-8'>
        <div className='h-1/2 lg:h-1/2 w-full absolute z-0'>
          <div className='h-full w-full relative'>
            <Image src="/images/petits-conteneurs.jpg" alt="photo de plantes en ligne" layout='fill'
              objectFit='cover' />
        ...
        <div className='h-5/6 lg:h-full w-full lg:w-5/6 relative z-10 flex flex-col justify-around items-center'>
          <h3 className='text-4xl lg:text-7xl lg:leading-relaxed font-bold text-white text-center'>
            Découvrez nos variétés d'arbres en petits conteneurs
          </h3>
        </div>
      </div>

<PlantList famille='Arbres Petits conteneurs'/>
</div>
